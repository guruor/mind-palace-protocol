...
def run_scenario() -> None:
    ...
    resolved = resolve_extension(reference, "0.8.0", fetcher)
    ...
    try:
        resolve_extension(changed, "0.8.0", fetcher)
    except ValueError:
        pass
    else:
    ...
    try:
        resolve_extension(dependency_reference, "0.8.0", lambda locator: dependency_payload)
    except ValueError:
        pass
    else:
    ...
    try:
        resolve_extension(executable_reference, "0.8.0", lambda locator: executable_payload)
    except ValueError:
        pass
    else:
